...
if __name__ == "__main__":
    ...
    for lr in [6e-2,4e-2,2e-2]:#,1e-2,9e-3,8.5e-3,8e-3]: #7.5e-3,7e-3,6e-3 are bad, 8e-2 is badder than 6e-2 in v9, 1e-2 is bad in v10

        my_config["save_path"] = f"C:/Users/harry/大型資料/RL_HW3_trained_models/improve_model_v13_lr{lr}"
